        ...
        <div className="">
          <div className="container mx-auto z-100 ">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center lg:gap-8">
              <div className=" p-4 lg:p-8 text-justify">
                <img
                  // className="w-full  object-cover  duration-300 hover:scale-105"
                  src={FirstImage}
                  alt=""
                />
                <h3 className="text-lg lg:text-2xl my-2  font-semibold font-inter text-header-color">
                  Industrial Applications
                </h3>
                <p className="text-sm lg:text-lg text-gray-500 text-opacity-75 font-inter">
              ...
              <div className=" p-4 lg:p-8 text-justify">
                ...
                <img
                  ...
                  alt=""
                />
                <h3 className=" text-header-color text-lg lg:text-2xl my-2  font-semibold font-inter">
                  Retail and Markets
                </h3>
                <p className="text-sm lg:text-lg text-gray-500 text-opacity-75 font-inter">
              ...
              <div className=" p-4 lg:p-8 text-justify z-100000">
                {" "}
                <img
                  // className="w-full aspect-w-1 h-full object-cover  duration-300 hover:scale-105"
                  src={ThirdImage}
                  alt="bnma"
                />
                <h3 className="text-lg lg:text-2xl my-2 text-header-color font-semibold font-inter">
                  Service Providers
                </h3>
                <p className="text-sm lg:text-lg text-gray-500 text-opacity-75 font-inter">
